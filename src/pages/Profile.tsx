      ...
      <div className="container max-w-4xl py-8 space-y-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Enhanced Stats Card */}
            <Card className="card-glass love-shadow">
              <CardContent className="p-6">
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div className="p-3 rounded-lg bg-love-gradient/10 hover:bg-love-gradient/20 transition-all duration-300">
                    <div className="text-3xl font-bold bg-love-gradient bg-clip-text text-transparent animate-pulse">94%</div>
                    <div className="text-xs text-muted-foreground font-medium">Profile Score</div>
                  </div>
                  <div className="p-3 rounded-lg bg-primary/10 hover:bg-primary/20 transition-all duration-300">
                    <div className="text-3xl font-bold text-primary">156</div>
                    <div className="text-xs text-muted-foreground font-medium">Profile Views</div>
                  </div>
                  <div className="p-3 rounded-lg bg-destructive/10 hover:bg-destructive/20 transition-all duration-300">
                    <div className="text-3xl font-bold text-destructive animate-heart-beat">23</div>
                    <div className="text-xs text-muted-foreground font-medium">❤️ Likes Today</div>
                  </div>
                  <div className="p-3 rounded-lg bg-success/10 hover:bg-success/20 transition-all duration-300">
